//  API_KEY = "c6ddf59d1fed486689e6b7a3f3b7aecb";
...
async function fetchNews (query){
   ...
   const res=  fetch(`https://newsapi.org/v2/everything?q=c6ddf59d1fed486689e6b7a3f3b7aecb`);
   const data = res.json();
...
function fillDataInCard(cardClone,article){
    ...
    const date = new Date(article.publicsheet).toLocaleDateString("en-U",{
